...
pipeline {
            ...
            parallel {
                stage('Build on AMD64') {
                    ...
                    steps {
                        ...
                        stash includes: 'release/**/*', name: 'release-amd64'
                    }
                }
                stage('Build on ARM64') {
                    ...
                    steps {
                        ...
                        stash includes: 'release/**/*', name: 'release-arm64'
                    }
                }
            }
        }
    ...
    post {
        success {
            echo "✅ Build successful for ${PROJECTNAME} v${VERSION}"
        }
        failure {
            echo "❌ Build failed for ${PROJECTNAME} v${VERSION}"
        }
        always {
            cleanWs()
        }
